...
*/
    ...
    public function testArticleIndex() {
        ...
        // $this->assertResponseOk(); //this equal with : 
    ...
    public function testArticleShow() {
        $article = Article::where('title', 'like', '%Testing Article title%')->first();
            ...
            if(empty($article)) {
            $data = array("title" => "Testing Article title", "content" => "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
            $post = $this->action('POST', 'ArticlesController@store', $data);
            }
    ...
    public function testArticleUpdateFails() {
        ...
        $post = $this->action('POST', 'ArticlesController@store', $data);
        $article = Article::where('title', 'like', 'Testing Article title')->first();
        $update_data = array("title" => "", "content" => "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
...
//TEST ACTION UPDATE (WITH SUCCESS SCHEM)
    ...
    $update_data = array("title" => "Edit Article Testing " . str_random(10), "content" => str_random(10)."Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
    $this->call('PUT', 'articles/'.$article->first()->id, $update_data);
